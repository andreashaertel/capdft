...
/** \file examples/surface_charge/src/main.cpp
...
// _____________________________________________________________________________
   ...
   */
// _____________________________________________________________________________
//-  std::vector<std::pair<std::vector<double>, double>> charge(0);
//-  double total_charge;
//-  std::cout << "calculate charge distr\n";
//-  charge_distribution(surface_left, system, total_ES,
//-		  &charge, &total_charge, resolution);
//-// _____________________________________________________________________________
...
//-    for (double pos : charge.at(i).first) {
//-      file << pos << " ";
//-    }
//-    file << charge.at(i).second << std::endl;
//-  }
//-  file.close();
//- 
//-  // all done
