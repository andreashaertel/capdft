...
/** \file examples/structured_functionals_all_tools/src/main.cpp
 *  \brief This is an example for the usage of the BoundarySurface class.
 *
 *  This example is based on ../../structured_functionals_some_tools/src/main.cpp
 *  with additional simplifications (e.g. usage of ParameterHandler instead of
